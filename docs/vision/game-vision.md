...
Deliver tense, replayable co-op runs where risk decisions matter every few minutes, and long-term account growth makes each return trip to town meaningful.

Implementation note:
- The product vision is co-op.
- The first playable implementation milestone is singleplayer-first, focused on validating the core loop and movement/combat foundations before multiplayer integration.
