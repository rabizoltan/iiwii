...
| `godot/scenes/debug/DebugOverlay.tscn` | scene | In-game debug menu shell opened by `F3` with shared debug toggle controls | `godot/scenes/main/DemoMain.tscn` | [debug-control-panel-slice.md](d:/Game/DEV/iiWii/iiwii/docs/workplans/debug-control-panel-slice.md) |
| `godot/scripts/debug/debug_overlay.gd` | script | Shared runtime debug state, menu visibility state, and projectile debug line spawning | `godot/scenes/debug/DebugOverlay.tscn` | [debug-control-panel-slice.md](d:/Game/DEV/iiWii/iiwii/docs/workplans/debug-control-panel-slice.md) |
