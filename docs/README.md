...
8. Optional task guidance in [`workplans/README.md`](d:/Game/DEV/iiWii/iiwii/docs/workplans/README.md)
...
- `workplans/`: execution guidance, sequencing, and handoff history. Useful for delivery, not product truth.
...
- Track current tuning and config ownership in [tuning-map.md](d:/Game/DEV/iiWii/iiwii/docs/technical/tuning-map.md).
- Track reusable validation entry points and fixtures in [validation-map.md](d:/Game/DEV/iiWii/iiwii/docs/technical/validation-map.md).
...
- Current engineering focus: the camera control and framing baseline is now complete and accepted for the current milestone.
- There is no newly chosen next gameplay slice yet; choose the next scope explicitly before opening a new active workplan.
...
- Camera and framing: [systems/camera-and-framing.md](d:/Game/DEV/iiWii/iiwii/docs/systems/camera-and-framing.md), [decisions/ADR-006-world-representation.md](d:/Game/DEV/iiWii/iiwii/docs/decisions/ADR-006-world-representation.md), [decisions/ADR-007-input-and-controls.md](d:/Game/DEV/iiWii/iiwii/docs/decisions/ADR-007-input-and-controls.md), [decisions/ADR-016-space-model-continuous-world-navmesh-no-tile-diagonals.md](d:/Game/DEV/iiWii/iiwii/docs/decisions/ADR-016-space-model-continuous-world-navmesh-no-tile-diagonals.md), [workplans/completed/camera-rotation-and-zoom-slice.md](d:/Game/DEV/iiWii/iiwii/docs/workplans/completed/camera-rotation-and-zoom-slice.md)
...
- Tuning and config ownership: [technical/tuning-map.md](d:/Game/DEV/iiWii/iiwii/docs/technical/tuning-map.md), [systems/tuning-and-stats.md](d:/Game/DEV/iiWii/iiwii/docs/systems/tuning-and-stats.md), [architecture/ai/enemy-ai-config-v1.md](d:/Game/DEV/iiWii/iiwii/docs/architecture/ai/enemy-ai-config-v1.md)
- Validation and test entry points: [technical/validation-map.md](d:/Game/DEV/iiWii/iiwii/docs/technical/validation-map.md), [architecture/ai/enemy-ai-testplan-v1.md](d:/Game/DEV/iiWii/iiwii/docs/architecture/ai/enemy-ai-testplan-v1.md), [workplans/completed/debug-control-panel-slice.md](d:/Game/DEV/iiWii/iiwii/docs/workplans/completed/debug-control-panel-slice.md)
- Current execution planning: [workplans/roadmaps/behavior-slice-roadmap.md](d:/Game/DEV/iiWii/iiwii/docs/workplans/roadmaps/behavior-slice-roadmap.md), [workplans/completed/camera-rotation-and-zoom-slice.md](d:/Game/DEV/iiWii/iiwii/docs/workplans/completed/camera-rotation-and-zoom-slice.md), [workplans/stale/combat-feedback-and-debug-behavior-slice.md](d:/Game/DEV/iiWii/iiwii/docs/workplans/stale/combat-feedback-and-debug-behavior-slice.md)
- Implementation status and code ownership: [feature-matrix.md](d:/Game/DEV/iiWii/iiwii/docs/technical/feature-matrix.md), [code-map.md](d:/Game/DEV/iiWii/iiwii/docs/architecture/code-map.md), [tuning-map.md](d:/Game/DEV/iiWii/iiwii/docs/technical/tuning-map.md), [development-governance.md](d:/Game/DEV/iiWii/iiwii/docs/technical/development-governance.md)
