...
- Current engineering focus: camera control and framing as the next non-navigation slice.
- The next planned gameplay slice is a Diablo-like camera pass covering soft-follow behavior, player-controlled rotation, zoom, and camera-relative movement updates.
...
- Current execution planning: [workplans/active/camera-rotation-and-zoom-slice.md](d:/Game/DEV/iiWii/iiwii/docs/workplans/active/camera-rotation-and-zoom-slice.md), [workplans/roadmaps/behavior-slice-roadmap.md](d:/Game/DEV/iiWii/iiwii/docs/workplans/roadmaps/behavior-slice-roadmap.md), [workplans/stale/combat-feedback-and-debug-behavior-slice.md](d:/Game/DEV/iiWii/iiwii/docs/workplans/stale/combat-feedback-and-debug-behavior-slice.md)
