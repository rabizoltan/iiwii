...
| Debug control panel slice | working | `F3` debug menu and shared toggles for enemy status, enemy nav path, and projectile debug lines are implemented and validated through main-scene runtime controls | [debug-control-panel-slice.md](d:/Game/DEV/iiWii/iiwii/docs/workplans/debug-control-panel-slice.md) |
