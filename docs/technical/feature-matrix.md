...
| Player crouch movement-state rules | working | `Ctrl` drives physical hold-to-crouch with lowered player capsule, scene-captured standing dimensions, upper-clearance stand-up validation, 40% movement slowdown, and attack/dodge/vault blocking while crouched; high-attack avoidance remains future scope | [movement-spec.md](d:/Game/DEV/iiWii/iiwii/docs/systems/movement-spec.md), [traversal-and-verticality.md](d:/Game/DEV/iiWii/iiwii/docs/systems/traversal-and-verticality.md), [player-crouch-movement-state-slice.md](d:/Game/DEV/iiWii/iiwii/docs/workplans/completed/player-crouch-movement-state-slice.md) |
...
| Traversal features | partial | Shared dodge/dash mobility, authored low-obstacle vault, and physical crouch are working; mantle/climb-up and broader traversal follow-ups remain pending | [traversal-and-verticality.md](d:/Game/DEV/iiWii/iiwii/docs/systems/traversal-and-verticality.md), [player-traversal-and-movement-slice-roadmap.md](d:/Game/DEV/iiWii/iiwii/docs/workplans/roadmaps/player-traversal-and-movement-slice-roadmap.md) |
