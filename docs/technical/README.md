...
This folder contains implementation constraints and team conventions.

## How To Use These Docs
- Read these after product, ADR, architecture, and system docs.
- Use them to constrain implementation style, validation, and file placement.
